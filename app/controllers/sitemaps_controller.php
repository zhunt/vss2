...
class SitemapsController extends AppController{
    ...
    function __get_data() {
        ...
        $this->__add_dynamic_section(
                             'Post',
                             ClassRegistry::init('Post')->find('all',
                                     array(
                                         'fields' => array('name', 'slug', 'Post.short_dek', 'Post.wp_created'),
                                         'conditions' => array(
                                             'Post.wp_status' => 'publish' ),
											'order' => 'Post.wp_created DESC'											 
                                         ) ),
                             array(
                                    'controllertitle' => 'My Posts',
                                    'fields' => array('id' => 'slug', 'date' => 'wp_created', 'title' => 'name' ),
                                    'changefreq' => 'monthly',
                                    'pr' => '0.5',
                                    'url' => array( 'controller' => 'post')
                                   )
                             );
        ...
        $this->__add_dynamic_section(
                             ...
                             array(
                                    ...
                                    'fields' => array('id' => 'slug', 'title' => 'full_name' ),
                                    'changefreq' => 'monthly',
                                    'pr' => '0.5',
                                    'url' => array('/')
                                   )
