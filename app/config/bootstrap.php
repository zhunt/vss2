...
Configure::write('Time.format_short_no_year', 'jS M'); // 10th Nov.
...
Configure::write('Facebook.commentUrl', 'http://SimcoeDining.com/');

Configure::write('Facebook.admins', 'zoltanh');
Configure::write('Facebook.appId', '195349083844956');
